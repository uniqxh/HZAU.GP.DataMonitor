create or replace package IMS_DATAMONITOR_PKG is
  ...
  procedure test(v_toMail varchar2, v_subject varchar2, v_body varchar2, cnt out number, fileName out varchar2);
  
  procedure qqInfo(v_toMail varchar2, v_subject varchar2, v_body varchar2, cnt out number, fileName out varchar2);
  ...
  function get_columns(i_name varchar2) return varchar2;
  
end IMS_DATAMONITOR_PKG;
/
create or replace package body IMS_DATAMONITOR_PKG is
  
  procedure test(v_toMail varchar2, v_subject varchar2, v_body varchar2, cnt out number, fileName out varchar2) as
  ...
  procedure qqInfo(v_toMail varchar2, v_subject varchar2, v_body varchar2, cnt out number, fileName out varchar2) is
    v_sql varchar2(1000) := 'select * from qqInfo';
  ...
  begin
    ...
    loop
      ...
      if cnt = 0 then
        ...
        utl_file.put_line(F, get_columns(t_name));
      end if;
...
function get_columns(i_name varchar2)
  return varchar2
  is
  ret varchar2(400);
  begin
