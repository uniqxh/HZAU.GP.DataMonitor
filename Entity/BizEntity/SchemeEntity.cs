...
{
    [Table(TableNames.SchemeEntity)]
   // [DataConflictPolicy(DataConflictPolicy = DataConflictPolicy.ThrowException, VerifyColumnName = "STAMP")]
    [DataContract]
    public class SchemeEntity
    {
        ...
        [Display(ResourceType = typeof(DisplayNames), Name = "CREATE_BY_NAME")]
        [DataMember]
        ...
        [Display(ResourceType = typeof(DisplayNames), Name = "CREATE_BY")]
        [DataMember]
